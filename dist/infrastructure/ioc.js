...
const ws_1 = __importDefault(require("./repositories/ws"));
...
container.register("ws", ws_1.default);
const ws = container.get("ws");
container.register("lead.creator", lead_create_1.LeadCreate).addArgument(ws);
container.register("status.creator", status_create_1.StatusCreate).addArgument(ws);
